...
TEST(ModelUtilsTest, ClassDetectionUseConfidenceInsteadOfClassConfidence){
    std::vector<Prediction> predictions = {
        { 0.21960784, 0.3137255, 0.18039216, 0.12941177, 0.85882354, {0.00784314, 0.0431373, 0.0745098} },
        { 0.627451, 0.3764706, 0.18039216, 0.12941177, 0.80784315, {0.00784314, 0.05882355, 0.0568628} },
        { 0.4392157, 0.59607846, 0.18039216, 0.12941177, 0.59607846, {0.01960784, 0.0313726, 0.0019608} }
    };
...
TEST(ModelUtilsTest, ConvertOutputToFloat){
    uint8_t dut[] = {
         16, 16, 40, 29, 5, 209, 30, 36,
         16, 16, 46, 33, 5, 198, 32, 33,
         16, 8, 85, 79, 2, 154, 26, 41,
         32, 16, 40, 44, 21, 253, 7, 17
    };
    ...
    std::vector<Prediction> expected_output = {
        { dut[0] / 255.0f, dut[1] / 255.0f, dut[2] / 255.0f, dut[3] / 255.0f, dut[4] / 255.0f, {dut[5] / 255.0f, dut[6] / 255.0f, dut[7] / 255.0f} },
        { dut[8] / 255.0f, dut[9] / 255.0f, dut[10] / 255.0f, dut[11] / 255.0f, dut[12] / 255.0f, {dut[13] / 255.0f, dut[14] / 255.0f, dut[15] / 255.0f} },
        { dut[16] / 255.0f, dut[17] / 255.0f, dut[18] / 255.0f, dut[19] / 255.0f, dut[20] / 255.0f, {dut[21] / 255.0f, dut[22] / 255.0f, dut[23] / 255.0f} },
        { dut[24] / 255.0f, dut[25] / 255.0f, dut[26] / 255.0f, dut[27] / 255.0f, dut[28] / 255.0f, {dut[29] / 255.0f, dut[30] / 255.0f, dut[31] / 255.0f} }
    };
    ...
    for( size_t i = 0; i < expected_output.size(); i++ ) {
        ...
        ASSERT_NEAR(predictions[i].confidence, expected_output[i].confidence, kTolerance);
        for( size_t j = 0; j < predictions[i].class_confidences.size(); j++ ) {
            ASSERT_NEAR(predictions[i].class_confidences[j], expected_output[i].class_confidences[j], kTolerance);
        }
    }
}
