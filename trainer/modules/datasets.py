...
if __name__ == '__main__':
    grid = (5,5)
    num_classes = 4
    train_dataset = CustomDataset('../dataset/images/train', '../dataset/labels/train', grid=grid, num_classes=num_classes)
    val_dataset = CustomDataset('../dataset/images/val', '../dataset/labels/val', grid=grid, num_classes=num_classes)
